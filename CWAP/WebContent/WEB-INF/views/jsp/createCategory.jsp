	...
	<div class="row">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 align="center">Create Enrollment Category</h3>
				<br>
						...
						<fieldset>
							<div class="form-group">
								...
								<label class="control-label col-sm-4" for="name">Enrollment
									Category Name: </label>
								<div class="col-sm-4">
									<input placeholder="Enrollment Category Name"
							...
							<div class="form-group">
								...
								<label class="control-label col-sm-4" for="description">Enrollment
									Category Description: </label>
								<div style="height: auto;" class="col-sm-4">
									<input placeholder="Enrollment Category Description"
